...
@onready var fireball = preload("res://src/features/player/fireball.tscn")
...
func _on_health_depleted() -> void:
	...
	await blink_overlay("res://src/worlds/realworld/realworld_classroom_one.tscn")

func show_death_screen():
	var scene = preload("res://src/shared/components/death_screen.tscn")
